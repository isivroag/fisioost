...
$consulta = "SELECT * FROM vconcepto WHERE estado_concepto = 1 ORDER BY id_concepto";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dat['costo_concepto'] ?></td>
                                                <td><?php echo $dat['precio_concepto'] ?></td>
                                                <td></td>
                                            </tr>
                                        <?php
                                        }
...
<script src="fjs/cntaconcepto.js"></script>
