...
$consulta = "SELECT * FROM cuentaing where estado_cuentaing=1 order by id_cuentaing";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-green text-light">
                <h1 class="card-title mx-auto">CUENTAS DE INGRESO</h1>
            </div>
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $dat['id_cuentaing'] ?></td>
                                                <td><?php echo $dat['nom_cuentaing'] ?></td>
                                                <td><?php echo $dat['tipo_cuentaing'] ?></td>
                                                <td><?php echo $dat['saldo_cuentaing'] ?></td>
                                                <td></td>
                                            </tr>
                                        <?php
                                        }
...
<script src="fjs/cntacuentasing.js"></script>
